...
[![Configs Collector](https://github.com/alihusainsorathiya/aliv2ray/actions/workflows/php.yml/badge.svg)](https://github.com/alihusainsorathiya/aliv2ray/actions/workflows/php.yml) [![Channels](https://github.com/alihusainsorathiya/aliv2ray/actions/workflows/channel_assets.yml/badge.svg)](https://github.com/alihusainsorathiya/aliv2ray/actions/workflows/channel_assets.yml)
...
## How it Works
The script includes two modules `get_data.php` and `config.php`. 

The `config.php` file contains an array of Telegram channels and the types of protocols they offer for V2ray subscriptions. 

The `get_data.php` module is responsible for fetching the latest subscription links from a Telegram channel and formatting them as plain text. It takes three arguments: `$channel` represents the Telegram channel name, `$type` represents the type of V2Ray protocol, and `$format` specifies the format of the output (text or JSON).

The main script iterates over each channel and the protocol types they offer, then passes the appropriate arguments to `get_data.php` to retrieve the subscription links. The collected links are then concatenated into a single string and saved to individual files based on their protocol type.
...
|---|---|---|---|---|
| MIX of ALL | [NORMAL SUBSCRIPTION](https://raw.githubusercontent.com/alihusainsorathiya/aliv2ray/main/sub/mix) | [BASE64 SUBSCRIPTION](https://raw.githubusercontent.com/alihusainsorathiya/aliv2ray/main/sub/mix_base64) | [CLASH SUBSCRIPTION](https://github.com/alihusainsorathiya/aliv2ray/raw/main/clash/mix.yml) | [CLASH.Meta SUBSCRIPTION](https://github.com/alihusainsorathiya/aliv2ray/raw/main/meta/mix.yml) |
| VMESS | [NORMAL SUBSCRIPTION](https://raw.githubusercontent.com/alihusainsorathiya/aliv2ray/main/sub/vmess) | [BASE64 SUBSCRIPTION](https://raw.githubusercontent.com/alihusainsorathiya/aliv2ray/main/sub/vmess_base64) | [CLASH SUBSCRIPTION](https://github.com/alihusainsorathiya/aliv2ray/raw/main/clash/vmess.yml) | [CLASH.Meta SUBSCRIPTION](https://github.com/alihusainsorathiya/aliv2ray/raw/main/meta/vmess.yml) |
| VLESS | [NORMAL SUBSCRIPTION](https://raw.githubusercontent.com/alihusainsorathiya/aliv2ray/main/sub/vless) | [BASE64 SUBSCRIPTION](https://raw.githubusercontent.com/alihusainsorathiya/aliv2ray/main/sub/vless_base64) | - | [CLASH.Meta SUBSCRIPTION](https://github.com/alihusainsorathiya/aliv2ray/raw/main/meta/vless.yml) |
| REALITY | [NORMAL SUBSCRIPTION](https://raw.githubusercontent.com/alihusainsorathiya/aliv2ray/main/sub/reality) | [BASE64 SUBSCRIPTION](https://raw.githubusercontent.com/alihusainsorathiya/aliv2ray/main/sub/reality_base64) | - | [CLASH.Meta SUBSCRIPTION](https://github.com/alihusainsorathiya/aliv2ray/raw/main/meta/reality.yml) |
| TROJAN | [NORMAL SUBSCRIPTION](https://raw.githubusercontent.com/alihusainsorathiya/aliv2ray/main/sub/trojan) | [BASE64 SUBSCRIPTION](https://raw.githubusercontent.com/alihusainsorathiya/aliv2ray/main/sub/trojan_base64) | [CLASH SUBSCRIPTION](https://github.com/alihusainsorathiya/aliv2ray/raw/main/clash/trojan.yml) | [CLASH.Meta SUBSCRIPTION](https://github.com/alihusainsorathiya/aliv2ray/raw/main/meta/trojan.yml) |
| ShadowSocks | [NORMAL SUBSCRIPTION](https://raw.githubusercontent.com/alihusainsorathiya/aliv2ray/main/sub/shadowsocks) | [BASE64 SUBSCRIPTION](https://raw.githubusercontent.com/alihusainsorathiya/aliv2ray/main/sub/shadowsocks_base64) | [CLASH SUBSCRIPTION](https://github.com/alihusainsorathiya/aliv2ray/raw/main/clash/shadowsocks.yml) | [CLASH.Meta SUBSCRIPTION](https://github.com/alihusainsorathiya/aliv2ray/raw/main/meta/shadowsocks.yml) |
...
For Example:
(OutputFormat) = clash
(SubUrl) = https://raw.githubusercontent.com/alihusainsorathiya/aliv2ray/main/sub/mix_base64

https://pub-api-1.bianyuan.xyz/sub?target=clash&url=https://raw.githubusercontent.com/alihusainsorathiya/aliv2ray/main/sub/mix_base64&insert=false
